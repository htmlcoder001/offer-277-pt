...
let idOrderBlock = document.querySelector('.order_form')
...
function openDoor(e) {
    ...
    setTimeout(function() {
        ...
        setTimeout(function() {
            ...
            doorWrapper.style.display = "none";
            orderBlock.style.display = "block";
            idOrderBlock.style.background = "url(./images/formbg.jpg) no-repeat 100% 100%"
            idOrderBlock.style.backgroundSize = "100% 100%"
            // start_timer();
        }, 1500);
    }, 1500);
